...
UPDATE STATISTICS FOR ssb_customer(c_custkey, c_city);
UPDATE STATISTICS FOR ssb_supplier(s_suppkey, s_city);
...
WHERE (ssb_customer.c_city = 'UNITED KI1' OR ssb_customer.c_city = 'UNITED KI5')
