...
UPDATE STATISTICS FOR tpch_lineitem(l_partkey, l_shipdate);
UPDATE STATISTICS FOR tpch_part(p_partkey);
...
from
	tpch_lineitem
	join tpch_part on tpch_lineitem.l_partkey = tpch_part.p_partkey
where
