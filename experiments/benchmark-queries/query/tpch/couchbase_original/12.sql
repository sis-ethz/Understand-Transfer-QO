...
UPDATE STATISTICS FOR tpch_lineitem(l_orderkey, l_shipmode, l_commitdate, l_receiptdate, l_shipdate);
...
from
	tpch_orders as o1
	join tpch_lineitem as l1 on o1.o_orderkey = l1.l_orderkey
where
