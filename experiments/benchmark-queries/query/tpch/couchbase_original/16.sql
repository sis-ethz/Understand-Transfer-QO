...
UPDATE STATISTICS FOR tpch_partsupp(ps_partkey, ps_suppkey);
UPDATE STATISTICS FOR tpch_part(p_partkey, p_brand, p_type, p_size);
UPDATE STATISTICS FOR tpch_supplier(s_comment);
