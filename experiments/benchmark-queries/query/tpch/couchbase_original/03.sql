...
CREATE INDEX temp_tpch_idx_3 ON tpch_lineitem(l_orderkey, l_shipdate);

UPDATE STATISTICS FOR tpch_customer(c_custkey, c_mktsegment);
UPDATE STATISTICS FOR tpch_customertpch_orders(o_custkey, o_orderkey, o_orderdate);
UPDATE STATISTICS FOR tpch_customer(l_orderkey, l_shipdate);
