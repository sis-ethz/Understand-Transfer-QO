...
UPDATE STATISTICS FOR tpch_lineitem(l_partkey, l_quantity, l_shipmode, l_shipinstruct);
UPDATE STATISTICS FOR tpch_part(p_partkey, p_brand, p_container, p_size);
