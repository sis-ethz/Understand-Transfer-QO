...
from
	(
		...
		from
			...
			JOIN tpch_orders AS o1 ON l1.l_orderkey = o1.o_orderkey
			JOIN tpch_customer AS c1 ON o1.o_custkey = c1.c_custkey
			JOIN tpch_nation AS n1 ON c1.c_nationkey = n1.n_nationkey
			JOIN tpch_nation AS n2 ON s1.s_nationkey = n2.n_nationkey
			JOIN tpch_region AS r1 ON n1.n_regionkey = r1.r_regionkey
		where
			r1.r_name = 'AMERICA'
