...
from
	tpch_partsupp
	JOIN tpch_part ON tpch_part.p_partkey = tpch_partsupp.ps_partkey
	JOIN tpch_supplier ON tpch_supplier.s_suppkey = tpch_partsupp.ps_suppkey
...
where
	...
	and tpch_partsupp.ps_supplycost = (
		...
		from
			...
			INNER JOIN tpch_supplier AS s0 ON ps0.s_suppkey = s0.ps_partkey
			INNER JOIN tpch_nation AS n0 ON s0.s_nationkey = n0.n_nationkey
			INNER JOIN tpch_region AS r0 ON n0.n_regionkey = r0.r_regionkey
		where
