...
from
	...
	join tpch_supplier as s2 USE HASH(BUILD) on ps2.ps_suppkey = s2.s_suppkey
	join tpch_nation as n2 USE HASH(BUILD) on s2.s_nationkey = n2.n_nationkey
...
having
	...
	(
		...
		from
			...
			join tpch_supplier as s1 USE HASH(BUILD) on ps1.ps_suppkey = s1.s_suppkey
