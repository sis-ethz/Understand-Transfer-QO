...
class mlp_classifier_model():
    ...
    def fit(self, X_train, y_train, batch_size=500, max_iter=200, device='cpu', debug_print=False):
...
class mlp_regressor_model():
    ...
    def fit(self, X_train, y_train, batch_size=200, max_iter=200, device='cpu', debug_print=False):
        # transform y into list of digits
